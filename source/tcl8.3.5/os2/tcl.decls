...
# Copyright (c) 2001-2002 by Illya Vaes (OS/2 support)
...
# AND OS/2, using platform {unix os2} does NOT work.
...
declare 1 os2 {
    HAB TclOS2GetHAB (void)
}

declare 2 os2 {
    HMQ TclOS2GetHMQ (HAB hab)
}

declare 3 os2 {
    BOOL TclOS2GetUsePm (void)
}

declare 4 os2 {
    void TclOS2SetUsePm (BOOL value)
}

declare 5 os2 {
    BOOL TclOS2PMInitialize (void)
}

declare 6 os2 {
    void TclOS2PMShutdown (void)
}
