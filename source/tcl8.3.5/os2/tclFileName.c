 ...
 * of: TCL_PLATFORM_UNIX, TCL_PLATFORM_MAC, TCL_PLATFORM_WINDOWS or
 * TCL_PLATFORM_OS2.
 */
				 ...
				 * May be NULL. */
{
	...
	case TCL_PLATFORM_WINDOWS:
	     ...
	     */
            ...
            /*
             * In the Cygwin world, call conv_to_win32_path in
             * the mount table to translate the file name into
             * Windows will understand.
             */
            cygwin_conv_to_win32_path(Tcl_DStringValue(headPtr)
