 ...
 * Copyright (c) 2000-2002 by Illya Vaes.
 *
...
/*
 * The following definitions set up the proper options for OS/2
 * compilers.  We use this method because don't use autoconf.
 */
