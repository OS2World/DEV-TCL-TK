...
EXTERN char *		TclpGetTZName _ANSI_ARGS_((int isdst));
/* 24 */
EXTERN char *		TclOS2NoBackslash _ANSI_ARGS_((char * path));
/* 25 */
EXTERN TclPlatformType * TclOS2GetPlatform _ANSI_ARGS_((void));
/* Slot 26 is reserved */
/* 27 */
EXTERN void		TclOS2FlushDirtyChannels _ANSI_ARGS_((void));
/* 28 */
EXTERN TclFile		TclOS2MakeFile _ANSI_ARGS_((HFILE handle));
/* 29 */
EXTERN Tcl_Channel	TclOS2OpenConsoleChannel _ANSI_ARGS_((HFILE handle, 
				char * channelName, int permissions));
/* 30 */
EXTERN Tcl_Channel	TclOS2OpenFileChannel _ANSI_ARGS_((HFILE handle, 
				char * channelName, int permissions, 
				int appendMode));
/* 31 */
EXTERN Tcl_Channel	TclOS2OpenSerialChannel _ANSI_ARGS_((HFILE handle, 
				char * channelName, int permissions));
/* 32 */
EXTERN int		TclOS2WaitForFile _ANSI_ARGS_((HFILE handle, 
...
typedef struct TclIntPlatStubs {
...
#endif /* __WIN32__ */
#ifdef __OS2__
    void (*tclOS2ConvertError) _ANSI_ARGS_((ULONG errCode)); /* 0 */
    void *reserved1;
    void *reserved2;
    void *reserved3;
    HMODULE (*tclOS2GetTclInstance) _ANSI_ARGS_((void)); /* 4 */
    void *reserved5;
    void *reserved6;
    void *reserved7;
    unsigned long (*tclpGetPid) _ANSI_ARGS_((Tcl_Pid pid)); /* 8 */
    ...
    TclFile (*tclpCreateTempFile) _ANSI_ARGS_((CONST char * contents)); /* 22 */
    char * (*tclpGetTZName) _ANSI_ARGS_((int isdst)); /* 23 */
    char * (*tclOS2NoBackslash) _ANSI_ARGS_((char * path)); /* 24 */
    TclPlatformType * (*tclOS2GetPlatform) _ANSI_ARGS_((void)); /* 25 */
    void *reserved26;
    void (*tclOS2FlushDirtyChannels) _ANSI_ARGS_((void)); /* 27 */
    TclFile (*tclOS2MakeFile) _ANSI_ARGS_((HFILE handle)); /* 28 */
    Tcl_Channel (*tclOS2OpenConsoleChannel) _ANSI_ARGS_((HFILE handle, char * channelName, int permissions)); /* 29 */
    Tcl_Channel (*tclOS2OpenFileChannel) _ANSI_ARGS_((HFILE handle, char * channelName, int permissions, int appendMode)); /* 30 */
    Tcl_Channel (*tclOS2OpenSerialChannel) _ANSI_ARGS_((HFILE handle, char * channelName, int permissions)); /* 31 */
    int (*tclOS2WaitForFile) _ANSI_ARGS_((HFILE handle, int mask, int timeout)); /* 32 */
#endif /* __OS2__ */
#ifdef MAC_TCL
...
#endif /* __WIN32__ */
#ifdef __OS2__
#ifndef TclOS2ConvertError
#define TclOS2ConvertError \
	(tclIntPlatStubsPtr->tclOS2ConvertError) /* 0 */
#endif
/* Slot 1 is reserved */
/* Slot 2 is reserved */
/* Slot 3 is reserved */
#ifndef TclOS2GetTclInstance
#define TclOS2GetTclInstance \
	(tclIntPlatStubsPtr->tclOS2GetTclInstance) /* 4 */
#endif
/* Slot 5 is reserved */
/* Slot 6 is reserved */
/* Slot 7 is reserved */
...
#define TclpGetTZName \
	(tclIntPlatStubsPtr->tclpGetTZName) /* 23 */
#endif
#ifndef TclOS2NoBackslash
#define TclOS2NoBackslash \
	(tclIntPlatStubsPtr->tclOS2NoBackslash) /* 24 */
#endif
#ifndef TclOS2GetPlatform
#define TclOS2GetPlatform \
	(tclIntPlatStubsPtr->tclOS2GetPlatform) /* 25 */
#endif
/* Slot 26 is reserved */
#ifndef TclOS2FlushDirtyChannels
#define TclOS2FlushDirtyChannels \
	(tclIntPlatStubsPtr->tclOS2FlushDirtyChannels) /* 27 */
#endif
#ifndef TclOS2MakeFile
#define TclOS2MakeFile \
	(tclIntPlatStubsPtr->tclOS2MakeFile) /* 28 */
#endif
#ifndef TclOS2OpenConsoleChannel
#define TclOS2OpenConsoleChannel \
	(tclIntPlatStubsPtr->tclOS2OpenConsoleChannel) /* 29 */
#endif
#ifndef TclOS2OpenFileChannel
#define TclOS2OpenFileChannel \
	(tclIntPlatStubsPtr->tclOS2OpenFileChannel) /* 30 */
#endif
#ifndef TclOS2OpenSerialChannel
#define TclOS2OpenSerialChannel \
	(tclIntPlatStubsPtr->tclOS2OpenSerialChannel) /* 31 */
#endif
#ifndef TclOS2WaitForFile
#define TclOS2WaitForFile \
	(tclIntPlatStubsPtr->tclOS2WaitForFile) /* 32 */
#endif
#endif /* __OS2__ */
#ifdef MAC_TCL
#ifndef TclpSysAlloc
