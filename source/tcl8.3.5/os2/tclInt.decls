...
# Copyright (c) 2001-2002 by Illya Vaes (OS/2 specific stuff)
...
############################
# OS/2 specific internals

declare 0 os2 {
    void TclOS2ConvertError(ULONG errCode)
}
# Windows' 1 not necessary
# Not in OS/2
#declare 2 os2 {
#    struct servent * TclOS2GetServByName(CONST char *nm, \
#	    CONST char *proto)
#}
# Not in OS/2
#declare 3 os2 {
#    int TclOS2GetSockOpt(SOCKET s, int level, int optname, \
#	    char FAR * optval, int FAR *optlen)
#}
declare 4 os2 {
    HMODULE TclOS2GetTclInstance(void)
}
# Removed in 8.1:
#  declare 5 os2 {
#      HMODULE TclOS2LoadLibrary(char *name)
#  }
# Not in OS/2
#declare 6 os2 {
#    u_short TclOS2NToHS(u_short ns)
#}
# Not in OS/2
#declare 7 os2 {
#    int TclOS2SetSockOpt(SOCKET s, int level, int optname, \
#	    CONST char FAR * optval, int optlen)
#}
declare 8 os2 {
    unsigned long TclpGetPid(Tcl_Pid pid)
...
# Not in OS/2
#declare 9 os2 {
#    int TclOS2GetPlatformId(void)
#}
# Removed in 8.3.1 (for Win32s only)
#declare 10 os2 {
#    int TclOS2SynchSpawn(void *args, int type, void **trans, Tcl_Pid *pidPtr)
#}
...
# not in OS/2
#declare 20 os2 {
#    void TclOS2AddProcess(ULONG pid, ULONG id)
#}
#  Removed permanently from 8.3.4 to match 8.4a2's removal
#
#declare 21 os2 {
...
declare 24 os2 {
    char * TclOS2NoBackslash(char *path)
}
declare 25 os2 {
    TclPlatformType *TclOS2GetPlatform(void)
}

# Added in Tcl 8.3.3 / 8.4

declare 27 os2 {
    void TclOS2FlushDirtyChannels (void)
}

declare 28 os2 {
    TclFile TclOS2MakeFile (HFILE handle)
}

declare 29 os2 {
    Tcl_Channel  TclOS2OpenConsoleChannel (HFILE handle, char *channelName, \
                     int permissions)
}

declare 30 os2 {
    Tcl_Channel TclOS2OpenFileChannel (HFILE handle, char *channelName, \
                    int permissions, int appendMode)
}

declare 31 os2 {
    Tcl_Channel TclOS2OpenSerialChannel (HFILE handle, char *channelName, \
                    int permissions)
}

declare 32 os2 {
    int TclOS2WaitForFile (HFILE handle, int mask, int timeout)
}
