...
# Copyright (c) 2001-2002 by Illya Vaes (support for OS/2)
...
#			of generic, win, os2, unix, or mac.
...
proc genStubs::addPlatformGuard {plat text} {
	...
	os2 {
	    return "#ifdef __OS2__\n${text}#endif /* __OS2__ */\n"
	}
	unix {
	    return "#if !defined(__WIN32__) && !defined(MAC_TCL) && !defined(__OS2__) /* UNIX */\n${text}#endif /* UNIX */\n"
	}		    
	mac {
