...
declare 12 os2 {
    void  TkOS2ClipboardRender (TkDisplay *dispPtr, ULONG format)
}

declare 13 os2 {
    MRESULT TkOS2EmbeddedEventProc (HWND hwnd, ULONG message, \
            MPARAM param1, MPARAM param2)
}

declare 14 os2 {
    void  TkOS2FillRect (HPS hps, LONG x, LONG y, LONG width, LONG height, \
	    LONG pixel)
}

declare 15 os2 {
    LONG  TkOS2GetBorderPixels (Tk_Window tkwin, Tk_3DBorder border, \
	    int which)
}

declare 16 os2 {
    HPS  TkOS2GetDrawablePS (Display *display, Drawable d, TkOS2PSState* state)
}

declare 17 os2 {
    int  TkOS2GetModifierState (void)
}

declare 18 os2 {
    HPAL  TkOS2GetSystemPalette (void)
}

declare 19 os2 {
    HWND  TkOS2GetWrapperWindow (Tk_Window tkwin)
}

declare 20 os2 {
    int  TkOS2HandleMenuEvent (HWND *phwnd, \
	    ULONG *pMessage, MPARAM *pParam1, MPARAM *pParam2, \
	    MRESULT *plResult)
}

declare 21 os2 {
    int  TkOS2IndexOfColor (XColor *colorPtr)
}

declare 22 os2 {
    void  TkOS2ReleaseDrawablePS (Drawable d, HPS hps, TkOS2PSState* state)
}

declare 23 os2 {
    MRESULT  TkOS2ResendEvent (PFNWP wndproc, HWND hwnd, XEvent *eventPtr)
}

declare 24 os2 {
    HPAL  TkOS2SelectPalette (HPS hps, HWND hwnd, Colormap colormap)
}

declare 25 os2 {
    void  TkOS2SetMenu (Tk_Window tkwin, ULONG hMenu)
}

declare 26 os2 {
    void  TkOS2SetWindowPos (HWND hwnd, HWND siblingHwnd, int pos)
}

declare 27 os2 {
    void  TkOS2WmCleanup (HMODULE hModule)
}

declare 28 os2 {
    void  TkOS2XCleanup (HMODULE hModule)
}

declare 29 os2 {
    void   TkOS2XInit (unsigned long modHandle)
}

# new for 8.1

declare 30 os2 {
    void TkOS2SetForegroundWindow (TkWindow *winPtr)
}

#declare 31 os2 {
#    void TkOS2DialogDebug (int debug)
#}

declare 32 os2 {
    Tcl_Obj * TkOS2GetMenuSystemDefault (Tk_Window tkwin, \
	    char *dbName, char *className)
}

#declare 33 os2 {
#    int TkOS2GetPlatformId(void)
#}

# OS/2 port auxiliary functions
declare 34 os2 {
    void  TkOS2SetStipple (HPS destPS, HPS bmpPS, HBITMAP stipple, \
                     LONG x, LONG y, LONG *oldPatternSet, PPOINTL oldRefPoint)
}
declare 35 os2 {
    void  TkOS2UnsetStipple (HPS destPS, HPS bmpPS, \
                     HBITMAP stipple, LONG oldPatternSet, PPOINTL oldRefPoint)
}
declare 36 os2 {
    HAB  TkOS2InitPM (void)
}
declare 37 os2 {
    void  TkOS2ExitPM (void)
}
declare 38 os2 {
    LONG  TkOS2WindowHeight (TkOS2Drawable *todPtr)
}
declare 39 os2 {
    LONG  TkOS2HwndHeight (HWND hwnd)
}
declare 40 os2 {
    int  TkOS2TranslateY (HWND hwnd, int y, int height)
}
declare 41 os2 {
    char * TkOS2ReverseImageLines (XImage *image, int height)
}
declare 42 os2 {
    LONG  TkOS2SelectFont (HPS hps, LONG hFont)
}
declare 43 os2 {
    LONG  TkOS2QueryTextWidth (HPS hps, CONST char *source, int numBytes)
}
declare 44 os2 {
    LONG  TkOS2CharString (HPS hps, CONST char *source, int numBytes, \
                           PPOINTL curPosPtr)
}
