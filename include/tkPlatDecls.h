...
#ifdef __OS2__
    Window (*tk_AttachHWND) _ANSI_ARGS_((Tk_Window tkwin, HWND hwnd)); /* 0 */
    HMODULE (*tk_GetHMODULE) _ANSI_ARGS_((void)); /* 1 */
    HWND (*tk_GetHWND) _ANSI_ARGS_((Window window)); /* 2 */
    Tk_Window (*tk_HWNDToWindow) _ANSI_ARGS_((HWND hwnd)); /* 3 */
    void (*tk_PointerEvent) _ANSI_ARGS_((HWND hwnd, int x, int y)); /* 4 */
    int (*tk_TranslateOS2Event) _ANSI_ARGS_((HWND hwnd, ULONG message, MPARAM param1, MPARAM param2, MRESULT * result)); /* 5 */
#endif /* __OS2__ */
#ifdef MAC_TCL
...
#define Tk_AttachHWND \
	(tkPlatStubsPtr->tk_AttachHWND) /* 0 */
#endif
#ifndef Tk_GetHMODULE
#define Tk_GetHMODULE \
	(tkPlatStubsPtr->tk_GetHMODULE) /* 1 */
#endif
#ifndef Tk_GetHWND
#define Tk_GetHWND \
	(tkPlatStubsPtr->tk_GetHWND) /* 2 */
...
#define Tk_PointerEvent \
	(tkPlatStubsPtr->tk_PointerEvent) /* 4 */
#endif
#ifndef Tk_TranslateOS2Event
#define Tk_TranslateOS2Event \
	(tkPlatStubsPtr->tk_TranslateOS2Event) /* 5 */
#endif
#endif /* __OS2__ */
#ifdef MAC_TCL
