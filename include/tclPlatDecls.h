...
/* 2 */
EXTERN HMQ		TclOS2GetHMQ _ANSI_ARGS_((HAB hab));
/* 3 */
EXTERN BOOL		TclOS2GetUsePm _ANSI_ARGS_((void));
/* 4 */
EXTERN void		TclOS2SetUsePm _ANSI_ARGS_((BOOL value));
/* 5 */
...
#ifdef __OS2__
    void *reserved0;
    HAB (*tclOS2GetHAB) _ANSI_ARGS_((void)); /* 1 */
    HMQ (*tclOS2GetHMQ) _ANSI_ARGS_((HAB hab)); /* 2 */
    BOOL (*tclOS2GetUsePm) _ANSI_ARGS_((void)); /* 3 */
    void (*tclOS2SetUsePm) _ANSI_ARGS_((BOOL value)); /* 4 */
    BOOL (*tclOS2PMInitialize) _ANSI_ARGS_((void)); /* 5 */
    void (*tclOS2PMShutdown) _ANSI_ARGS_((void)); /* 6 */
#endif /* __OS2__ */
#ifdef MAC_TCL
...
#ifndef TclOS2GetHAB
#define TclOS2GetHAB \
	(tclPlatStubsPtr->tclOS2GetHAB) /* 1 */
#endif
#ifndef TclOS2GetHMQ
#define TclOS2GetHMQ \
	(tclPlatStubsPtr->tclOS2GetHMQ) /* 2 */
#endif
#ifndef TclOS2GetUsePm
#define TclOS2GetUsePm \
	(tclPlatStubsPtr->tclOS2GetUsePm) /* 3 */
#endif
#ifndef TclOS2SetUsePm
#define TclOS2SetUsePm \
	(tclPlatStubsPtr->tclOS2SetUsePm) /* 4 */
#endif
#ifndef TclOS2PMInitialize
#define TclOS2PMInitialize \
	(tclPlatStubsPtr->tclOS2PMInitialize) /* 5 */
#endif
#ifndef TclOS2PMShutdown
#define TclOS2PMShutdown \
	(tclPlatStubsPtr->tclOS2PMShutdown) /* 6 */
#endif
#endif /* __OS2__ */
#ifdef MAC_TCL
